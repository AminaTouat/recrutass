<body>
    ...
    <form action="{{ route('offre.update',$offre->id) }}" method="POST">
         ...
         <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Title:</strong>
                    <input type="text" id="intitule" name="intitule" value="{{ $offre->intitule }}" class="form-control" placeholder="Title">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Description:</strong>
                    <textarea class="form-control" style="height:150px" id="description" name="description" placeholder="Description">{{ $offre->description }}</textarea>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <select id="Type"  class="form-control jform-chosen-validate" required aria-required="true" value="{{ $offre->Type }}" name="Type" data-placeholder="Choisir Contrat emploi">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <select id="domaine"  class="form-control form-control-chosen ignore-valid jform-chosen-validate" required aria-required="true"  value="{{ $offre->domaine }}" name="domaine" data-placeholder="Choisir Catégorie emploi">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>lieu de travaille:</strong>
                    <input type="text" id="lieutravail" name="lieutravail" value="{{ $offre->lieutravail }}" class="form-control" placeholder="Title">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Date de clôture de cet emploi:</strong>
                    <input type="text" class="form-control" id="datefin" name="datefin" placeholder="datefin" value="{{ $offre->datefin }}">
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" id="compétence" name="compétence" value="{{ $offre->compétence }}" class="form-control" placeholder="compétence">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Année Experience:</strong>
                    <input type="text" class="form-control" id="annéeExperience" name="annéeExperience" placeholder="annéeExperience" value="{{ $offre->annéeExperience }}">
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" id="duréemploi" name="duréemploi" value="{{ $offre->duréemploi }}" class="form-control" placeholder="duréemploi">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Site web d'entreprise:</strong>
                    <input type="text" class="form-control" id="url" name="url" placeholder="url" value="{{ $offre->url }}">
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" id="niveau" name="niveau" value="{{ $offre->niveau }}" class="form-control" placeholder="niveau">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>salaire:</strong>
                    <input type="text" class="form-control" id="prix" name="prix" placeholder="prix" value="{{ $offre->prix }}">
                </div>
            </div>
