...
<div class="jobsearch-main-content">
                        ...
                        <div class="jobsearch-typo-wrap">
                            <div class="jobsearch-employer-dashboard-nav">
                                ...
                                <ul>
                                    ...
                                    <li> <a href="active"> <i class="jobsearch-icon jobsearch-heart"></i>Candidats Sélectionnés </a></li>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="jobsearch-profile-title"><h2>Candidats Sélectionnés</h2></div><p>Aucun enregistrement trouvé.</p></div>
</div></div></div>
</div></div></div>
@endsection