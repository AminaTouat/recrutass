    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav text-uppercase ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="{{url('inscrire')}}"> <button class="btn btn-primary">S'INSCRIRE</button></a>
          </li>
          <li class="nav-item">
  ...
  <header class="masthead">
    <div class="container">
      <div class="intro-text">
        <div class="intro-lead-in">A dieux le chômage</div>
        <div class="intro-lead-in">&</div>
        <div class="intro-heading text-uppercase"> Bienvenue a la vie professionnelle</div>
